 ...
 * {@link com.rocket.summer.framework.scheduling.concurrent.ThreadPoolTaskScheduler},
 ...
 * @see com.rocket.summer.framework.scheduling.concurrent.ThreadPoolTaskScheduler
 */
public interface TaskScheduler {
     ...
     * e.g. a {@link com.rocket.summer.framework.scheduling.support.CronTrigger} object
     * wrapping a cron expression
     * @return a {@link ScheduledFuture} representing pending completion of the task,
     * or {@code null} if the given Trigger object never fires (i.e. returns
     * {@code null} from {@link Trigger#nextExecutionTime})
     * @throws com.rocket.summer.framework.core.task.TaskRejectedException if the given task was not accepted
