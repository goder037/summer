 ...
 * {@link com.rocket.summer.framework.expression.Expression} with both an
 * {@code EvaluationContext} and a root object as arguments:
 * {@link com.rocket.summer.framework.expression.Expression#getValue(EvaluationContext, Object)}.
 *
...
public class SimpleEvaluationContext implements EvaluationContext {
    ...
    public static class Builder {
         ...
         * {@link com.rocket.summer.framework.core.convert.support.DefaultConversionService} is used.
         ...
         * @see com.rocket.summer.framework.expression.Expression#getValue(EvaluationContext)
         * @see com.rocket.summer.framework.expression.Expression#getValue(EvaluationContext, Object)
         */
