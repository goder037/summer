 ...
 * a message via a {@link com.rocket.summer.framework.context.MessageSource}.
 *
 * @author Juergen Hoeller
 * @since 13.02.2004
 * @see com.rocket.summer.framework.context.MessageSource#getMessage(MessageSourceResolvable, java.util.Locale)
 */
