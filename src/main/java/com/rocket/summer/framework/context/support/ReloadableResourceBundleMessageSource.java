...
/**
 * Spring-specific {@link com.rocket.summer.framework.context.MessageSource} implementation
 * that accesses resource bundles using specified basenames, participating in the
 * Spring {@link com.rocket.summer.framework.context.ApplicationContext}'s resource loading.
 *
 ...
 * loading them via a {@link com.rocket.summer.framework.util.PropertiesPersister} strategy
 ...
 * {@link com.rocket.summer.framework.context.ApplicationContext}: it will use a
 * {@link com.rocket.summer.framework.core.io.DefaultResourceLoader} as default,
 ...
 * @see com.rocket.summer.framework.util.DefaultPropertiesPersister
...
public class ReloadableResourceBundleMessageSource extends AbstractResourceBasedMessageSource
     ...
     * @see #setBasenames
     * @see com.rocket.summer.framework.util.PropertiesPersister#load
     */
