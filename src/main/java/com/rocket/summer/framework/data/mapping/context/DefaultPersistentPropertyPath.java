...
class DefaultPersistentPropertyPath<T extends PersistentProperty<T>> implements PersistentPropertyPath<T> {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#toDotPath()
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#toDotPath(com.rocket.summer.framework.core.convert.converter.Converter)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#toPath(java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#toPath(java.lang.String, com.rocket.summer.framework.core.convert.converter.Converter)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#getLeafProperty()
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#getBaseProperty()
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#isBasePathOf(com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#getExtensionForBaseOf(com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#getParentPath()
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#getLength()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.rocket.summer.framework.data.mapping.context.PersistentPropertyPath#isEmpty()
     */
