...
public class ClassGeneratingEntityInstantiator implements EntityInstantiator {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.convert.EntityInstantiator#createInstance(com.rocket.summer.framework.data.mapping.PersistentEntity, com.rocket.summer.framework.data.mapping.model.ParameterValueProvider)
     */
    @Override
    ...
    static class ObjectInstantiatorClassGenerator {
         ...
         * <p>
         * Taken from Spring Expression 4.1.2 {@code com.rocket.summer.framework.expression.spel.CodeFlow#insertUnboxInsns}.
         *
