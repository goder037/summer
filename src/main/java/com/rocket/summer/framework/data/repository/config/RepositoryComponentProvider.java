...
import com.rocket.summer.framework.data.repository.NoRepositoryBean;
...
class RepositoryComponentProvider extends ClassPathScanningCandidateComponentProvider {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.context.annotation.ClassPathScanningCandidateComponentProvider#isCandidateComponent(com.rocket.summer.framework.beans.factory.annotation.AnnotatedBeanDefinition)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.context.annotation.ClassPathScanningCandidateComponentProvider#getRegistry()
     */
    @Override
    ...
    /**
     * {@link com.rocket.summer.framework.core.type.filter.TypeFilter} that only matches interfaces. Thus setting this up makes
    ...
    private static class InterfaceTypeFilter extends AssignableTypeFilter {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.core.type.filter.AbstractTypeHierarchyTraversingFilter#match(com.rocket.summer.framework.core.type.classreading.MetadataReader, com.rocket.summer.framework.core.type.classreading.MetadataReaderFactory)
         */
        @Override
