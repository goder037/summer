...
import com.rocket.summer.framework.beans.PropertyAccessor;
...
import com.rocket.summer.framework.data.redis.FallbackExceptionTranslationStrategy;
import com.rocket.summer.framework.data.redis.RedisSystemException;
import com.rocket.summer.framework.data.redis.connection.*;
import com.rocket.summer.framework.data.redis.connection.ClusterCommandExecutor.ClusterCommandCallback;
import com.rocket.summer.framework.data.redis.connection.ClusterCommandExecutor.MultiKeyClusterCommandCallback;
import com.rocket.summer.framework.data.redis.connection.ClusterCommandExecutor.NodeResult;
...
import com.rocket.summer.framework.data.redis.core.ScanCursor;
import com.rocket.summer.framework.data.redis.core.ScanIteration;
...
public class JedisClusterConnection implements RedisClusterConnection {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisCommands#execute(java.lang.String, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#del(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#type(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#keys(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#keys(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#randomKey()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#randomKey(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#rename(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#renameNX(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#expire(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#pExpire(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#expireAt(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#pExpireAt(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#persist(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#move(byte[], int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#sort(byte[], com.rocket.summer.framework.data.redis.connection.SortParameters)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#sort(byte[], com.rocket.summer.framework.data.redis.connection.SortParameters, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#dump(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#restore(byte[], long, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#get(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#getSet(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#mGet(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#set(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#setNX(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#setEx(byte[], long, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#mSet(java.util.Map)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#mSetNX(java.util.Map)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#incr(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#incrBy(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#incrBy(byte[], double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#decr(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#decrBy(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#append(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#getRange(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#setRange(byte[], byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisStringCommands#strLen(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#rPush(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lPush(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#rPushX(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lPushX(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lLen(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lRange(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lTrim(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lIndex(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lInsert(byte[], com.rocket.summer.framework.data.redis.connection.RedisListCommands.Position, byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lSet(byte[], long, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lRem(byte[], long, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#lPop(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#rPop(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#bLPop(int, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#bRPop(int, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#rPopLPush(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisListCommands#bRPopLPush(int, byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sAdd(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sRem(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sPop(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sMove(byte[], byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sCard(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sIsMember(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sInter(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sInterStore(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sUnion(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sUnionStore(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sDiff(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sDiffStore(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sMembers(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sRandMember(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sRandMember(byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisSetCommands#sScan(byte[], com.rocket.summer.framework.data.redis.core.ScanOptions)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zAdd(byte[], double, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zAdd(byte[], java.util.Set)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRem(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zIncrBy(byte[], double, byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRank(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRank(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRange(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRemRangeByScore(byte[], com.rocket.summer.framework.data.redis.connection.RedisZSetCommands.Range)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeWithScores(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], double, double, long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScoreWithScores(byte[], double, double, long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRange(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRangeWithScores(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScore(byte[], double, double, long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRevRangeByScoreWithScores(byte[], double, double, long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zCount(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zCard(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zScore(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRemRange(byte[], long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRemRangeByScore(byte[], double, double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zUnionStore(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zUnionStore(byte[], com.rocket.summer.framework.data.redis.connection.RedisZSetCommands.Aggregate, int[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], java.lang.String, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisZSetCommands#zRangeByScore(byte[], java.lang.String, java.lang.String, long, long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hSet(byte[], byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hSetNX(byte[], byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hGet(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hMGet(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hMSet(byte[], java.util.Map)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hIncrBy(byte[], byte[], long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hIncrBy(byte[], byte[], double)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hExists(byte[], byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hDel(byte[], byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hLen(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hKeys(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hVals(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisHashCommands#hGetAll(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisTxCommands#multi()
     */
    @Override
    public void multi() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisTxCommands#exec()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisTxCommands#discard()
     */
    @Override
    public void discard() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisTxCommands#watch(byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisTxCommands#unwatch()
     */
    @Override
    public void unwatch() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisPubSubCommands#isSubscribed()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisPubSubCommands#getSubscription()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnectionCommands#select(int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnectionCommands#echo(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnectionCommands#ping()
     */
    @Override
    public String ping() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#ping(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#bgWriteAof()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#bgReWriteAof(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#bgReWriteAof()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#bgSave()
     */
    @Override
    public void bgSave() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#bgSave(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#lastSave()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#lastSave(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#save()
     */
    @Override
    public void save() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#save(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#dbSize()
     */
    @Override
    public Long dbSize() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#dbSize(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#flushDb()
     */
    @Override
    public void flushDb() {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#flushDb(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#flushAll()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#flushAll(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#info()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#info(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#info(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#info(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#shutdown()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#shutdown(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#getConfig(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#getConfig(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#setConfig(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#setConfig(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, java.lang.String, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#resetConfigStats()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#resetConfigStats(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#time(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#killClient(java.lang.String, int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#setClientName(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisServerCommands#getClientList()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterConnection#getClientList(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#scriptFlush()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#scriptKill()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#scriptLoad(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#scriptExists(java.lang.String[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#eval(byte[], com.rocket.summer.framework.data.redis.connection.ReturnType, int, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#evalSha(java.lang.String, com.rocket.summer.framework.data.redis.connection.ReturnType, int, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisScriptingCommands#evalSha(byte[], com.rocket.summer.framework.data.redis.connection.ReturnType, int, byte[][])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisKeyCommands#exists(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterSetSlot(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, int, com.rocket.summer.framework.data.redis.connection.RedisClusterCommands.AddSlots)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetKeysInSlot(int, java.lang.Integer)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterAddSlots(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, int[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterAddSlots(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, com.rocket.summer.framework.data.redis.connection.RedisClusterNode.SlotRange)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterCountKeysInSlot(int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterDeleteSlots(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, int[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterDeleteSlotsInRange(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, com.rocket.summer.framework.data.redis.connection.RedisClusterNode.SlotRange)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterForget(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterMeet(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterReplicate(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#getClusterSlotForKey(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetNodeForSlot(int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetNodes()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetSlaves(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetMasterSlaveMap()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetNodeForKey(byte[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisClusterCommands#clusterGetClusterInfo()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#isClosed()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#getNativeConnection()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#isQueueing()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#isPipelined()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#openPipeline()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#closePipeline()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.redis.connection.RedisConnection#getSentinelConnection()
     */
    @Override
    ...
    static class JedisClusterNodeResourceProvider implements ClusterNodeResourceProvider {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.redis.connection.ClusterNodeResourceProvider#getResourceForSpecificNode(com.rocket.summer.framework.data.redis.connection.RedisClusterNode)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.redis.connection.ClusterNodeResourceProvider#returnResourceForSpecificNode(com.rocket.summer.framework.data.redis.connection.RedisClusterNode, java.lang.Object)
         */
        @Override
    ...
    static class JedisClusterTopologyProvider implements ClusterTopologyProvider {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.redis.connection.ClusterTopologyProvider#getTopology()
         */
        @Override
