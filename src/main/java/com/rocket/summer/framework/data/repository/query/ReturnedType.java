...
import com.rocket.summer.framework.data.mapping.model.PreferredConstructorDiscoverer;
import com.rocket.summer.framework.data.projection.ProjectionFactory;
import com.rocket.summer.framework.data.projection.ProjectionInformation;
...
public abstract class ReturnedType {
    ...
    private static final class ReturnedInterface extends ReturnedType {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedTypeInformation#getReturnedType()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ReturnedType#needsCustomConstruction()
         */
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedType#isProjecting()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedTypeInformation#getTypeToRead()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedTypeInformation#getInputProperties()
         */
        @Override
    ...
    private static final class ReturnedClass extends ReturnedType {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedType#getTypeToRead()
         */
        public Class<?> getTypeToRead() {
            return type;
        }
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ResultFactory.ReturnedType#needsCustomConstruction()
         */
        public boolean needsCustomConstruction() {
