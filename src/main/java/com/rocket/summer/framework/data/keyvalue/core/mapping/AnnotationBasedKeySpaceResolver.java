...
import com.rocket.summer.framework.core.style.ToStringCreator;
...
import com.rocket.summer.framework.data.keyvalue.core.mapping.AnnotationBasedKeySpaceResolver.MetaAnnotationUtils.AnnotationDescriptor;
...
enum AnnotationBasedKeySpaceResolver implements KeySpaceResolver {
     ...
     * such as {@link com.rocket.summer.framework.test.context.ContextConfiguration @ContextConfiguration},
     * {@link com.rocket.summer.framework.test.context.TestExecutionListeners @TestExecutionListeners}, and
     * {@link com.rocket.summer.framework.test.context.ActiveProfiles @ActiveProfiles} which offer support for merging and
     * overriding various <em>inherited</em> annotation attributes (e.g.,
     * {@link com.rocket.summer.framework.test.context.ContextConfiguration#inheritLocations}).
     *
     * @author Sam Brannen
     * @since 4.0
     * @see AnnotationUtils
