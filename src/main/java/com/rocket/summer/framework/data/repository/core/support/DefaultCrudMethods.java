...
import static com.rocket.summer.framework.util.ClassUtils.*;
...
import com.rocket.summer.framework.data.repository.CrudRepository;
...
public class DefaultCrudMethods implements CrudMethods {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#getSaveMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#hasSaveMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#getFindAllMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#hasFindAllMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#getFindOneMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#hasFindOneMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#hasDelete()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.CrudMethods#getDeleteMethod()
     */
    @Override
