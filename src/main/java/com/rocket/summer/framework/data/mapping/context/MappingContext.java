...
public interface MappingContext<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
     ...
     *
     * @see com.rocket.summer.framework.data.mapping.model.SimpleTypeHolder#isSimpleType(Class)
     ...
     *         {@link com.rocket.summer.framework.data.mapping.model.SimpleTypeHolder#isSimpleType(Class)}).
     */
