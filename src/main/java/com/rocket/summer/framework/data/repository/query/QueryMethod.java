...
import com.rocket.summer.framework.data.repository.core.EntityMetadata;
...
public class QueryMethod {
    ...
    public boolean isSliceQuery() {
        return !isPageQuery() && com.rocket.summer.framework.util.ClassUtils.isAssignable(Slice.class, unwrappedReturnType);
    }
    ...
    public final boolean isPageQuery() {
        return com.rocket.summer.framework.util.ClassUtils.isAssignable(Page.class, unwrappedReturnType);
    }
