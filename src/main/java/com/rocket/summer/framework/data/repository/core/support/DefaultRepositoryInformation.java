...
import static com.rocket.summer.framework.core.GenericTypeResolver.*;
import static com.rocket.summer.framework.data.repository.util.ClassUtils.*;
...
import com.rocket.summer.framework.data.annotation.QueryAnnotation;
...
class DefaultRepositoryInformation implements RepositoryInformation {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryMetadata#getDomainClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryMetadata#getIdClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryInformation#getRepositoryBaseClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryInformation#getTargetClassMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryInformation#getQueryMethods()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryInformation#isCustomMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.RepositoryInformation#isQueryMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.RepositoryInformation#isBaseClassMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.support.RepositoryInformation#hasCustomMethod()
     */
    @Override
