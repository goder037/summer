...
import com.rocket.summer.framework.data.repository.query.EvaluationContextExtensionInformation.ExtensionTypeInformation;
import com.rocket.summer.framework.data.repository.query.EvaluationContextExtensionInformation.RootObjectInformation;
import com.rocket.summer.framework.data.repository.query.spi.EvaluationContextExtension;
import com.rocket.summer.framework.data.repository.query.spi.Function;
...
import com.rocket.summer.framework.expression.spel.support.ReflectivePropertyAccessor;
...
public class ExtensionAwareEvaluationContextProvider implements EvaluationContextProvider, ApplicationContextAware {
    ...
    /* (non-Javadoc)
     * @see com.rocket.summer.framework.data.jpa.repository.support.EvaluationContextProvider#getEvaluationContext()
     */
    @Override
    ...
    private class ExtensionAwarePropertyAccessor implements PropertyAccessor, MethodResolver {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.data.repository.query.ExtensionAwareEvaluationContextProvider.ReadOnlyPropertyAccessor#canRead(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.String)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.PropertyAccessor#read(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.String)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.MethodResolver#resolve(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.String, java.util.List)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.PropertyAccessor#canWrite(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.String)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.PropertyAccessor#write(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.String, java.lang.Object)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.PropertyAccessor#getSpecificTargetClasses()
         */
        @Override
    ...
    private static class FunctionMethodExecutor implements MethodExecutor {
        ...
        /*
         * (non-Javadoc)
         * @see com.rocket.summer.framework.expression.MethodExecutor#execute(com.rocket.summer.framework.expression.EvaluationContext, java.lang.Object, java.lang.Object[])
         */
        @Override
