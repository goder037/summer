...
public class ClassGeneratingPropertyAccessorFactory implements PersistentPropertyAccessorFactory {
    ...
    private static final boolean IS_JAVA_7_OR_BETTER = com.rocket.summer.framework.util.ClassUtils
     ...
     * 			Class class_1 = Class.forName("com.rocket.summer.framework.data.mapping.Person");
     * 			Class class_2 = Class.forName("com.rocket.summer.framework.data.mapping.PersonWithId");
    ...
    static class PropertyAccessorClassGenerator {
        ...
        private static void visitSetProperty(PersistentEntity<?, ?> entity,
            ...
            MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "setProperty",
                    "(Lcom/rocket/summer/framework/data/mapping/PersistentProperty;Ljava/lang/Object;)V",
                    "(Lcom/rocket/summer/framework/data/mapping/PersistentProperty<*>;Ljava/lang/Object;)V", null);
            mv.visitCode();
