...
import com.rocket.summer.framework.data.type.classreading.MethodsMetadataReaderFactory;
...
class DefaultProjectionInformation implements ProjectionInformation {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.projection.ProjectionInformation#getType()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.projection.ProjectionInformation#getInputProperties()
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.projection.ProjectionInformation#isDynamic()
     */
    @Override
