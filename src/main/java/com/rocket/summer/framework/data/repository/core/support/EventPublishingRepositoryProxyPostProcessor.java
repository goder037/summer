...
import com.rocket.summer.framework.data.domain.AfterDomainEventPublication;
import com.rocket.summer.framework.data.domain.DomainEvents;
...
public class EventPublishingRepositoryProxyPostProcessor implements RepositoryProxyPostProcessor {
    ...
    /*
     * (non-Javadoc)
     * @see com.rocket.summer.framework.data.repository.core.support.RepositoryProxyPostProcessor#postProcess(com.rocket.summer.framework.aop.framework.ProxyFactory, com.rocket.summer.framework.data.repository.core.RepositoryInformation)
     */
    @Override
