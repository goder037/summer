...
import com.rocket.summer.framework.scheduling.SchedulingAwareRunnable;
...
public class RedisMessageListenerContainer implements InitializingBean, DisposableBean, BeanNameAware, SmartLifecycle {
     ...
     * <p>
     * The default implementation builds a {@link com.rocket.summer.framework.core.task.SimpleAsyncTaskExecutor} with the
     * specified bean name (or the class name, if no bean name specified) as thread name prefix.
     *
     * @see com.rocket.summer.framework.core.task.SimpleAsyncTaskExecutor#SimpleAsyncTaskExecutor(String)
     */
    ...
    private class SubscriptionTask implements SchedulingAwareRunnable {
         ...
         *
         * @author Thomas Darimont
         * @see com.rocket.summer.framework.data.redis.listener.RedisMessageListenerContainer.SubscriptionTask.SubscriptionPresentTestCondition
         */
     ...
     * {@link com.rocket.summer.framework.data.redis.listener.RedisMessageListenerContainer.SpinBarrier}
     *
     * @author Jennifer Hickey
     * @author Thomas Darimont Note: Placed here to avoid API exposure.
     */
