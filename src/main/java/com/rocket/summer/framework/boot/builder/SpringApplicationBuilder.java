...
import com.rocket.summer.framework.boot.Banner;
...
public class SpringApplicationBuilder {
    ...
    /**
     * Creates a new {@link com.rocket.summer.framework.boot.SpringApplication} instances from the
     * given sources. Subclasses may override in order to provide a custom subclass of
     * {@link com.rocket.summer.framework.boot.SpringApplication}
     * @param sources the sources
     * @return the {@link com.rocket.summer.framework.boot.SpringApplication} instance
     * @since 1.1.0
     */
