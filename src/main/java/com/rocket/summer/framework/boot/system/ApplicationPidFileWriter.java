...
import com.rocket.summer.framework.boot.context.event.SpringApplicationEvent;
...
public class ApplicationPidFileWriter
     ...
     * {@link com.rocket.summer.framework.boot.context.event.ApplicationStartingEvent} to trigger
