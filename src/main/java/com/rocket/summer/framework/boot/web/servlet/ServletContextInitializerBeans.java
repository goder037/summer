...
public class ServletContextInitializerBeans
    ...
    private MultipartConfigElement getMultipartConfig(ListableBeanFactory beanFactory) {
        List<Map.Entry<String, MultipartConfigElement>> beans = getOrderedBeansOfType(
    ...
    private <T> List<Map.Entry<String, T>> getOrderedBeansOfType(
    ...
    private <T> List<Map.Entry<String, T>> getOrderedBeansOfType(
        ...
        List<Map.Entry<String, T>> beans = new ArrayList<Map.Entry<String, T>>();
        Comparator<Map.Entry<String, T>> comparator = new Comparator<Map.Entry<String, T>>() {
