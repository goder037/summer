 ...
 * with @{@link com.rocket.summer.framework.context.annotation.Configuration Configuration}
 * classes as follows:
 *
 * <pre class="code">
 * &#064;Configuration
 ...
 *
 *     <bean id="cacheManager" class="com.rocket.summer.framework.cache.support.SimpleCacheManager">
 *         <property name="caches">
 *             <set>
 *                 <bean class="com.rocket.summer.framework.cache.concurrent.ConcurrentMapCacheFactoryBean">
 ...
 * {@link com.rocket.summer.framework.cache.interceptor.CacheInterceptor CacheInterceptor} and the
 * proxy- or AspectJ-based advice that weaves the interceptor into the call stack when
 * {@link com.rocket.summer.framework.cache.annotation.Cacheable @Cacheable} methods are invoked.
 *
 ...
 *
 * <p><strong>A bean of type {@link com.rocket.summer.framework.cache.CacheManager CacheManager}
 ...
 * com.rocket.summer.framework.cache.interceptor.KeyGenerator KeyGenerator} SPI. Normally,
 * {@code @EnableCaching} will configure Spring's
 * {@link com.rocket.summer.framework.cache.interceptor.SimpleKeyGenerator SimpleKeyGenerator}
 ...
 * to extend from {@link com.rocket.summer.framework.cache.annotation.CachingConfigurerSupport
 ...
 * @see com.rocket.summer.framework.cache.aspectj.AspectJCachingConfiguration
 */
