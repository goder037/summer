 ...
 * @since 1.2
 * @see com.rocket.summer.framework.jmx.export.assembler.MetadataMBeanInfoAssembler#setAttributeSource
 * @see com.rocket.summer.framework.jmx.export.MBeanExporter#setAssembler
 */
