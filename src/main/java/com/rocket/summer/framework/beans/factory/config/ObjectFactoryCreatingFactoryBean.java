...
/**
 * A {@link com.rocket.summer.framework.beans.factory.FactoryBean} implementation that
 * returns a value which is an {@link com.rocket.summer.framework.beans.factory.ObjectFactory}
 * that in turn returns a bean sourced from a {@link com.rocket.summer.framework.beans.factory.BeanFactory}.
 *
 * <p>As such, this may be used to avoid having a client object directly calling
 * {@link com.rocket.summer.framework.beans.factory.BeanFactory#getBean(String)} to get
 * a (typically prototype) bean from a
 * {@link com.rocket.summer.framework.beans.factory.BeanFactory}, which would be a
 * violation of the inversion of control principle. Instead, with the use
 * of this class, the client object can be fed an
 * {@link com.rocket.summer.framework.beans.factory.ObjectFactory} instance as a
 ...
 * {@link com.rocket.summer.framework.beans.factory.BeanFactory} might look as follows:
 *
 ...
 *       class="com.rocket.summer.framework.beans.factory.config.ObjectFactoryCreatingFactoryBean"&gt;
 ...
 * Spring-specific interface such as {@link com.rocket.summer.framework.beans.factory.ObjectFactory},
 ...
 * @since 1.0.2
 * @see com.rocket.summer.framework.beans.factory.ObjectFactory
