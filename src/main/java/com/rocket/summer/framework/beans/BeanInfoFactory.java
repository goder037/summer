 ...
 * by using the {@link com.rocket.summer.framework.core.io.support.SpringFactoriesLoader}
 * utility class.
 *
 ...
 *
 * <p>Note that the {@link com.rocket.summer.framework.core.io.support.SpringFactoriesLoader}
 * sorts the {@code BeanInfoFactory} instances by
 * {@link com.rocket.summer.framework.core.annotation.Order @Order}, so that ones with a
 * higher precedence come first.
 *
 * @author Arjen Poutsma
 * @since 3.2
 * @see CachedIntrospectionResults
 * @see com.rocket.summer.framework.core.io.support.SpringFactoriesLoader
 */
