 ...
 * underlying {@link com.rocket.summer.framework.beans.factory.BeanFactory}.
 *
 * <p>Such service locators permit the decoupling of calling code from
 * the {@link com.rocket.summer.framework.beans.factory.BeanFactory} API, by using an
 ...
 * {@link com.rocket.summer.framework.beans.factory.NoSuchBeanDefinitionException}
 * is thrown.
 *
 * <p>On invocation of the single-arg factory method with a non-null (and
 * non-empty) argument, the proxy returns the result of a
 * {@link com.rocket.summer.framework.beans.factory.BeanFactory#getBean(String)} call,
 ...
 *            class="com.rocket.summer.framework.beans.factory.config.ServiceLocatorFactoryBean">
