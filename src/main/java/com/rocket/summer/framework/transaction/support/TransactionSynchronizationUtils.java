...
import com.rocket.summer.framework.core.InfrastructureProxy;
...
public abstract class TransactionSynchronizationUtils {
    ...
    private static final boolean aopAvailable = ClassUtils.isPresent(
            "com.rocket.summer.framework.aop.scope.ScopedObject", TransactionSynchronizationUtils.class.getClassLoader());
     ...
     * @see com.rocket.summer.framework.core.InfrastructureProxy#getWrappedObject()
     */
