 ...
 * @see com.rocket.summer.framework.jdbc.datasource.DataSourceUtils#CONNECTION_SYNCHRONIZATION_ORDER
 */
public interface TransactionSynchronization extends Flushable {
     ...
     * @see com.rocket.summer.framework.transaction.TransactionStatus#flush()
     */
    @Override
    void flush();
