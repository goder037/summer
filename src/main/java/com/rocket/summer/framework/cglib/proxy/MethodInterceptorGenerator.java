...
import com.rocket.summer.framework.cglib.core.ClassInfo;
        ...
        implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.proxy.MethodInterceptor");
