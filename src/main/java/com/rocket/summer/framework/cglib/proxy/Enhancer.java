...
import com.rocket.summer.framework.cglib.core.DuplicatesPredicate;
...
import com.rocket.summer.framework.cglib.core.MethodInfoTransformer;
import com.rocket.summer.framework.cglib.core.MethodWrapper;
import com.rocket.summer.framework.cglib.core.ObjectSwitchCallback;
import com.rocket.summer.framework.cglib.core.ProcessSwitchCallback;
...
import com.rocket.summer.framework.cglib.core.Transformer;
import com.rocket.summer.framework.cglib.core.TypeUtils;
import com.rocket.summer.framework.cglib.core.VisibilityPredicate;
import com.rocket.summer.framework.cglib.core.WeakCacheKey;
 ...
 * which callback is used on a per-method basis with a {@link com.rocket.summer.framework.cglib.proxy.CallbackFilter}.
 * <p>
...
public class Enhancer extends AbstractClassGenerator
{
    ...
    private static final Enhancer.EnhancerKey KEY_FACTORY =
            (Enhancer.EnhancerKey) KeyFactory.create(Enhancer.EnhancerKey.class, KeyFactory.HASH_ASM_TYPE, null);
    ...
    /**
     * {@link com.rocket.summer.framework.cglib.core.AbstractClassGenerator.ClassLoaderData#generatedClasses} requires to keep cache key
     * in a good shape (the keys should be up and running if the proxy class is alive), and one of the cache keys is
     * {@link com.rocket.summer.framework.cglib.proxy.CallbackFilter}. That is why the generated class contains static field that keeps strong reference to
     * the {@link #filter}.
     * <p>This dance achieves two goals: ensures generated class is reusable and available through generatedClasses
     * cache, and it enables to unload classloader and the related {@link com.rocket.summer.framework.cglib.proxy.CallbackFilter} in case user does not need
     * that</p>
     */
    ...
    private static final Type FACTORY =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.proxy.Factory");
    ...
    private static final Type CALLBACK =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.proxy.Callback");
    private static final Type CALLBACK_ARRAY =
            Type.getType(com.rocket.summer.framework.cglib.proxy.Callback[].class);
    ...
    private com.rocket.summer.framework.cglib.proxy.CallbackFilter filter;
    private com.rocket.summer.framework.cglib.proxy.Callback[] callbacks;
    ...
    /**
     * Set the {@link com.rocket.summer.framework.cglib.proxy.CallbackFilter} used to map the generated class' methods
     ...
     * @see #setCallbacks
     */
    public void setCallbackFilter(com.rocket.summer.framework.cglib.proxy.CallbackFilter filter) {
        this.filter = filter;
    }


    /**
     * Set the single {@link com.rocket.summer.framework.cglib.proxy.Callback} to use.
     * Ignored if you use {@link #createClass}.
     * @param callback the callback to use for all methods
     * @see #setCallbacks
     */
    public void setCallback(final com.rocket.summer.framework.cglib.proxy.Callback callback) {
        setCallbacks(new com.rocket.summer.framework.cglib.proxy.Callback[]{ callback });
    }

    /**
     * Set the array of callbacks to use.
     * Ignored if you use {@link #createClass}.
     * You must use a {@link com.rocket.summer.framework.cglib.proxy.CallbackFilter} to specify the index into this
     * array for each method in the proxied class.
     * @param callbacks the callback array
     * @see #setCallbackFilter
     * @see #setCallback
     */
    public void setCallbacks(com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
    ...
    /**
     * Set the single type of {@link com.rocket.summer.framework.cglib.proxy.Callback} to use.
     ...
     * and {@link Enhancer#setThreadCallbacks(Class, com.rocket.summer.framework.cglib.proxy.Callback[])}
     */
    static class EnhancerFactoryData {
        ...
        public EnhancerFactoryData(Class generatedClass, Class[] primaryConstructorArgTypes, boolean classOnly) {
            ...
            try {
                ...
                throw new com.rocket.summer.framework.cglib.core.CodeGenerationException(e);
            }
        }
         ...
         */
        public Object newInstance(Class[] argumentTypes, Object[] arguments, com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
        ...
        private void setThreadCallbacks(com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
            try {
                setThreadCallbacks.invoke(generatedClass, (Object) callbacks);
            } catch (IllegalAccessException e) {
                throw new com.rocket.summer.framework.cglib.core.CodeGenerationException(e);
            } catch (InvocationTargetException e) {
                throw new com.rocket.summer.framework.cglib.core.CodeGenerationException(e.getTargetException());
            }
        }
    }
    ...
    private Object createHelper() {
        ...
        Object key = KEY_FACTORY.newInstance((superclass != null) ? superclass.getName() : null,
                ...
                filter == ALL_ZERO ? null : new WeakCacheKey<com.rocket.summer.framework.cglib.proxy.CallbackFilter>(filter),
                callbackTypes,
                useFactory,
    ...
    protected Object wrapCachedClass(Class klass) {
        ...
        Enhancer.EnhancerFactoryData factoryData = new Enhancer.EnhancerFactoryData(klass, argumentTypes, classOnly);
    ...
    protected Object unwrapCachedValue(Object cached) {
        if (currentKey instanceof Enhancer.EnhancerKey) {
            Enhancer.EnhancerFactoryData data = ((WeakReference<Enhancer.EnhancerFactoryData>) cached).get();
            return data;
        }
    ...
    /**
     * Call this method to register the {@link com.rocket.summer.framework.cglib.proxy.Callback} array to use before
     ...
     * @see #setUseFactory
     */
    public static void registerCallbacks(Class generatedClass, com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
     ...
     * class are created
     */
    public static void registerStaticCallbacks(Class generatedClass, com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
    ...
    private static void setThreadCallbacks(Class type, com.rocket.summer.framework.cglib.proxy.Callback[] callbacks) {
        setCallbacksHelper(type, callbacks, SET_THREAD_CALLBACKS_NAME);
    }

    private static void setCallbacksHelper(Class type, com.rocket.summer.framework.cglib.proxy.Callback[] callbacks, String methodName) {
        // TODO: optimize
        try {
    ...
    private static Method getCallbacksSetter(Class type, String methodName) throws NoSuchMethodException {
        return type.getDeclaredMethod(methodName, new Class[]{ com.rocket.summer.framework.cglib.proxy.Callback[].class });
    }
     ...
     * @param callback the callback to use for all methods
     */
    public static Object create(Class type, com.rocket.summer.framework.cglib.proxy.Callback callback) {
     ...
     * @param callback the callback to use for all methods
     */
    public static Object create(Class superclass, Class interfaces[], com.rocket.summer.framework.cglib.proxy.Callback callback) {
        Enhancer e = new Enhancer();
