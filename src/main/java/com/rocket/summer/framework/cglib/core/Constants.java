...
import com.rocket.summer.framework.cglib.core.AsmApi;
...
public interface Constants extends Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("com.rocket.summer.framework.cglib.core.Signature");
