...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
            TypeUtils.parseType("com.rocket.summer.framework.cglib.transform.impl.InterceptFieldEnabled");
