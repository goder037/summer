...
import com.rocket.summer.framework.cglib.core.internal.Function;
import com.rocket.summer.framework.cglib.core.internal.LoadingCache;
        ...
        implements ClassGenerator
{
    ...
    private static volatile Map<ClassLoader, AbstractClassGenerator.ClassLoaderData> CACHE = new WeakHashMap<ClassLoader, AbstractClassGenerator.ClassLoaderData>();

    private static final boolean DEFAULT_USE_CACHE =
            Boolean.parseBoolean(System.getProperty("cglib.useCache", "true"));

    private GeneratorStrategy strategy = DefaultGeneratorStrategy.INSTANCE;
    private NamingPolicy namingPolicy = com.rocket.summer.framework.cglib.core.DefaultNamingPolicy.INSTANCE;
    ...
    protected static class ClassLoaderData {
        ...
        /**
         * {@link com.rocket.summer.framework.cglib.core.AbstractClassGenerator} here holds "cache key" (e.g. {@link Enhancer}
     ...
     * @see com.rocket.summer.framework.cglib.core.DefaultNamingPolicy
