...
class BeanMapEmitter extends ClassEmitter {
    private static final Type BEAN_MAP = TypeUtils.parseType("com.rocket.summer.framework.cglib.beans.BeanMap");
    private static final Type FIXED_KEY_SET = TypeUtils.parseType("com.rocket.summer.framework.cglib.beans.FixedKeySet");
