...
/**
 * {@link com.rocket.summer.framework.beans.factory.FactoryBean} that creates a simple
...
public class SimpleHttpServerFactoryBean implements FactoryBean<HttpServer>, InitializingBean, DisposableBean {
     ...
     * objects as values
     * @see com.rocket.summer.framework.remoting.httpinvoker.SimpleHttpInvokerServiceExporter
