 ...
 *
 * <pre class="code">&lt;bean id="viewResolver" class="com.rocket.summer.framework.web.servlet.view.InternalResourceViewResolver"&gt;
...
public class InternalResourceView extends AbstractUrlBasedView {
     ...
     * @see com.rocket.summer.framework.web.util.WebUtils#isIncludeRequest
     */
