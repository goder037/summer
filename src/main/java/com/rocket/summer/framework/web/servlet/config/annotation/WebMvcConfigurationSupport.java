...
import com.rocket.summer.framework.web.method.support.CompositeUriComponentsContributor;
...
import com.rocket.summer.framework.web.servlet.handler.HandlerMappingIntrospector;
...
import com.rocket.summer.framework.web.servlet.mvc.method.annotation.JsonViewRequestBodyAdvice;
import com.rocket.summer.framework.web.servlet.mvc.method.annotation.JsonViewResponseBodyAdvice;
import com.rocket.summer.framework.web.servlet.mvc.method.annotation.RequestBodyAdvice;
...
import com.rocket.summer.framework.web.servlet.mvc.method.annotation.ResponseBodyAdvice;
import com.rocket.summer.framework.web.servlet.mvc.support.DefaultHandlerExceptionResolver;
import com.rocket.summer.framework.web.servlet.resource.ResourceUrlProvider;
import com.rocket.summer.framework.web.servlet.resource.ResourceUrlProviderExposingInterceptor;
import com.rocket.summer.framework.web.servlet.view.InternalResourceViewResolver;
import com.rocket.summer.framework.web.servlet.view.ViewResolverComposite;
 ...
 * {@link com.rocket.summer.framework.web.bind.annotation.ExceptionHandler} methods.
 * <li>{@link ResponseStatusExceptionResolver} for exceptions annotated with
 * {@link com.rocket.summer.framework.web.bind.annotation.ResponseStatus}.
 ...
 * <li>an {@link com.rocket.summer.framework.validation.beanvalidation.OptionalValidatorFactoryBean}
...
public class WebMvcConfigurationSupport implements ApplicationContextAware, ServletContextAware {
    ...
    public Validator mvcValidator() {
        ...
        if (validator == null) {
            if (ClassUtils.isPresent("javax.validation.Validator", getClass().getClassLoader())) {
                Class<?> clazz;
                try {
                    String className = "com.rocket.summer.framework.validation.beanvalidation.OptionalValidatorFactoryBean";
     ...
     * {@link com.rocket.summer.framework.web.servlet.mvc.method.annotation.MvcUriComponentsBuilder}.
     * @since 4.0
     */
    @Bean
     ...
     * {@link com.rocket.summer.framework.core.Ordered#HIGHEST_PRECEDENCE
