...
import com.rocket.summer.framework.core.annotation.SynthesizingMethodParameter;
...
/**
 * Creates instances of {@link com.rocket.summer.framework.web.util.UriComponentsBuilder}
 ...
 * {@link com.rocket.summer.framework.web.servlet.support.ServletUriComponentsBuilder#fromCurrentServletMapping()}.
 ...
 * {@link #relativeTo(com.rocket.summer.framework.web.util.UriComponentsBuilder)}.
 * </ul>
 *
...
public class MvcUriComponentsBuilder {
     ...
     * <p>The configured
     * {@link com.rocket.summer.framework.web.servlet.handler.HandlerMethodMappingNamingStrategy
     ...
     * {@link com.rocket.summer.framework.web.method.support.UriComponentsContributor
    ...
    private static <T> T initProxy(Class<?> type, ControllerMethodInvocationInterceptor interceptor) {
        if (type.isInterface()) {
            ...
            enhancer.setCallbackType(com.rocket.summer.framework.cglib.proxy.MethodInterceptor.class);
    ...
    private static class ControllerMethodInvocationInterceptor
            implements com.rocket.summer.framework.cglib.proxy.MethodInterceptor, MethodInterceptor {
