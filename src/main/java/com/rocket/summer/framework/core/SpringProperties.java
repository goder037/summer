 ...
 * @since 3.2.7
 * @see com.rocket.summer.framework.core.env.AbstractEnvironment#IGNORE_GETENV_PROPERTY_NAME
 * @see com.rocket.summer.framework.beans.CachedIntrospectionResults#IGNORE_BEANINFO_PROPERTY_NAME
 * @see com.rocket.summer.framework.jdbc.core.StatementCreatorUtils#IGNORE_GETPARAMETERTYPE_PROPERTY_NAME
 * @see com.rocket.summer.framework.test.context.cache.ContextCache#MAX_CONTEXT_CACHE_SIZE_PROPERTY_NAME
 */
